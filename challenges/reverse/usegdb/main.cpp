...
const vector<unsigned char> data = {176, 126, 163, 145, 211, 166, 177, 252, 3, 68, 84, 165, 220, 17, 86, 252, 133, 134, 245, 165, 237, 82, 47, 77};
...
int main()
{
	...
	string flag = "flag-D3bu663rs4r34w3s0m3";
