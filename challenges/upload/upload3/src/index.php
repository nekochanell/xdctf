<?php
// flag-50758dad6bb177bb882b33ad9d14aa0f
session_start();
...
if (isset($_FILES["upfile"])) {
	...
	} else if (strrpos($filename, ".png") === false && strrpos($filename, ".jpg") === false &&
		       strrpos($filename, ".jpeg" === false && strrpos($filename, ".gif") === false)) {
		echo "This file extension is not supported.";
